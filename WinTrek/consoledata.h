...
public:
        ...
        m_pfn(pfn)
    {
        ...
        ZAssert(pfn != NULL);
        AddEventTarget(&TMemberSnapshotValue::OnEvent, peventSource);
    }
...
//        pns->AddMember("GetModelTypeIcon",  new TMemberSnapshotValueFactory<ModelData, TRef<Image> >(&ModelData::GetModelTypeIcon));
...
//        pns->AddMember("GetSideIcon",  new TMemberSnapshotValueFactory<ModelData, TRef<Image> >(&ModelData::GetSideIcon));
