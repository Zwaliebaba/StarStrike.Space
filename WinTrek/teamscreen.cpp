...
private:
    ...
    public:
        ...
        TeamSettingsDialogPopup(TRef<INameSpace> pns, TeamScreen* pparent)
        {
            ...
            AddEventTarget(&TeamSettingsDialogPopup::OnButtonOk, m_pbuttonOk->GetEventSource());
            AddEventTarget(&TeamSettingsDialogPopup::OnButtonCancel, m_pbuttonCancel->GetEventSource());
